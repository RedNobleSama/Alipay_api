...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2021000118629822",
        app_notify_url="http://120.78.222.167/trade/alipay/return",  # 异步请求
        app_private_key_path=private_key_path,
        alipay_public_key_path=ali_pub_key_path,  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
        return_url="http://120.78.222.167/trade/alipay/return"  # 支付成功后跳转到商家页面 # 同步请求
    )
    ...
    url = alipay.direct_pay(
        subject="测试订单2",
        out_trade_no="20170202997",
        total_amount=100,
        return_url="http://120.78.222.167/trade/alipay/return"  # 支付成功后跳转到商家页面
    )
